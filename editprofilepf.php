   ...
   height="85px"></a>
    ...
    <li>   <a href="feedbackfinance.php">Feedback</a></li>
          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Setting <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="editprofilepf.php">Edit profile</a></li>
...
$n=$_SESSION['username'];
?>
<div class="container1" style="margin-top:90px;margin-left:0px;"><center>
<?php 
...
<div class="login-wrap">
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      ...
      <form class="sign-up-htm" action="updatepf.php" method="POST" name="account" enctype="multipart/form-data" onsubmit="return validateForm();">
        <div class="group ">
