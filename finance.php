        ...
        <ul class="nav menu">
           ...
           <li> <a href="finance.php" ><span class="glyphicon glyphicon-home"></span>Home</a></li>
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="displaypayment.php" >payment</a></li>
...
<hr>
 ...
 <div class="bb">
 <a href="displayitemf.php"><img class="zoom" src="images/vr.jfif" width="200px" height="200px"></a><br><br>
<p> View Items</p>
 </div>
 <div class="cc">
 <a href="viewrequestf.php"><img class="zoom" src="images/vr.png" width="200px" height="200px"></a><br><br>
<p>  View Request</p>
 </div>
  
 
 <div class="dd">
  <a href="feedbackfinance.php"><img class="zoom" src="images/fs.png" width="200px" height="200px"></a><br><br>
<p>    Send Feedback</p>
 </div>
 <div class="ee">
  <a href="editprofilepf.php"><img class="zoom" src="images/ep.png" width="200px" height="200px"></a><br><br>
<p>    Update Profile</p>
 </div>
  <div class="cc">
 <a href="payment.php"><img class="zoom" src="images/pay1.jpg" width="200px" height="200px"></a><br><br>
<p>  pay to winner supplier</p>
 </div>
