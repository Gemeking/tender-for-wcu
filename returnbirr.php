...
<div id="form_wrap">
			...
			<form  action="conta.php" method="post" name="f1" onsubmit="return vali()" id="for">
				<center><p class="ccc">return bid price form</p></center>
				<label for="name">return birr: </label>
				<input name="t1" type="text" id="t1" onchange="return name()" value="100" required="true"  />
				...
				<input name="t1" type="text" id="t1" onchange="return name()" value="0"  required="true" disabled  class="btn btn-info active" data-toggle="modal" data-target="#modal" />
