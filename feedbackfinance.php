...
<div class="container">
    ...
    <form class="well form-horizontal" action="feedbackf.php " method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <textarea  name="message" placeholder="enter feedback" class="form-control"  type="textarea"></textarea>
    </div>
  </div>
</div>
