...
<center><h2 style="color:black;margin-top:80px;"> Items that are registered</h2></center>
		<hr>
		<div class="aaa">
</div>
...
<input readonly class="form-control" type="text"id="no2" name="no"  required></div>
<div class="form-group">
<label class="control-label col-sm-2" for="registerdate"><i>register Date:</i></label>

<input readonly style="width:380px;"class="form-control" type="date"id="date2" name="date"  required></div>
<div class="form-group">
<label class="control-label col-sm-2" for="item name"><i>Item name:</i></label>

<input readonly class="form-control" type="text" id="iname2"name="itemname" required></div>
<div class="form-group">
<label class="control-label col-sm-2" for="item model"><i>Discription:</i></label>

<input readonly class="form-control" type="text" id="imodel2"name="itemmodel" required></div>
<div class="form-group">
<label class="control-label col-sm-2" for="item model"><i>quantity:</i></label>

<input readonly class="form-control" type="text" id="quantity"name="quantity" required></div>
<div class="form-group">
<label class="control-label col-sm-2" for="item model"><i>unitprice:</i></label>

<input readonly class="form-control" type="text" id="unitprice"name="unitprice" required></div>
<div class="form-group">
