   ...
   height="85px"></a>
    ...
    <li>  <a href="noticedisplaypr.php" target="iframe2">Notice</a></li>
	 <li> <a href="viewrequest.php" target="iframe2">Request</a></li>
	  <li> <a href="viewfeedback.php" target="iframe2">From Property_Depa
	    (<?php 
...
?>)
      ...
      <li> <a href="viewfeedbackfinance.php" target="iframe2">From finance</a></li>
...
<div class="login-wrap">
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      ...
      <form class="sign-up-htm" action="updateppr.php" method="POST" name="account" enctype="multipart/form-data" onsubmit="return validateForm();">
        <div class="group ">
