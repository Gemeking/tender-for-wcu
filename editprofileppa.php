...
<link rel="stylesheet" type="text/css" href="css/stylelogin.css">
  ...
  #section1 {padding-top:50px;height:600px;color: #fff; }
...
$n=$_SESSION['username'];
?>
<div class="container" style="margin-top:80px;"><center>
<?php 
...
<div class="login-wrap">
  ...
  <div class="login-html">
    ...
    <div class="login-form">
      ...
      <form class="sign-up-htm" action="updateppa.php" method="POST" name="account" enctype="multipart/form-data" onsubmit="return validateForm();">
        <div class="group ">
        ...
        <!---<div class="group">
          ...
          <input id="pass" type="password" class="input" data-type="password" name="confirm_password" onKeyPress="return validateForm()" value="<?php echo $confirm_password?>"; required >
