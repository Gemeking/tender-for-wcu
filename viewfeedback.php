...
<th colspan="2">View</th>
			  ...
			  <?php
			  $result = mysqli_query($mysql,"SELECT * FROM feedback");
			  if($result === false){
...
<input disabled style="width:380px;" class="form-control" type="date"id="date" name="date"  required></div>
<div class="form-group">
<div class="form-group">
<label class="control-label col-sm-2" for="feedback"><i>Feedback</i></label>

<textarea disabled style="width:380px;"class="form-control" type="textarea"id="feedback" name="feedback"  required></textarea></div>
