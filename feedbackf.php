...
$sql="INSERT INTO feedbackfin (itemname,itemmodel,firstname,lastname,email,date,message,status) 
...
echo"<script type='text/javascript'>alert('feedback send sucessfully!!!');window.open('feedbackfinance.php','_self')</script>".mysqli_error($mysql);
...
echo"A feedback send fail!".mysqli_error($mysql);
 ...
 //echo"<script type='text/javascript'>alert('data not   inserted');window.open('feedbackfinance.php','_self')</script>".mysqli_error($mysql);
