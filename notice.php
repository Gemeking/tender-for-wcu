...
<fieldset>
    ...
    <legend>Form of Post notice:</legend>
<form class="form-inline" action="notice2.php" method="post">
 <!-- <div class="form-group mb-2">
    <label for="staticdatel2" class="label">Date</label>
    <input type="date" name="date" class="aaa" class="form-control"   required>
  </div><br><br>-->
  <div class="form-group mx-sm-3 mb-2">
    <label for="title" class="label">Reg_No</label>
    <input type="text" class="aaa"  name="no" class="form-control"
     id="text" placeholder="write the number" required>
  </div><br><br>
  <div class="form-group mx-sm-3 mb-2">
    <label for="title" class="label">target</label>
    <input type="text" class="aaa"  name="target"class="form-control" 
    id="text" placeholder="for who prepared this " required>
  </div><br><br>
   <div class="form-group mx-sm-3 mb-2">
    <label for="title" class="label">post_by</label>
    <input type="text" class="aaa"  name="postt"class="form-control" id="text"
     placeholder=" " required>
  </div><br><br>
  <div class="form-group mx-sm-3 mb-2">
    <label for="title" class="label">Title</label>
    <input type="text" class="aaa"  name="title"class="form-control" 
    id="text" placeholder="write the title" required>
  </div><br><br>
   <div class="form-group mx-sm-3 mb-2">
    <label for="title" class="label">notice</label>
      <textarea class="textarea" required name="message"  
      placeholder="please write notice in this"></textarea>
  </div><br><br>
  <button type="submit" class="btn btn-success  active" name="post">Post</button>
