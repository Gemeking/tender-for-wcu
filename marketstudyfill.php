...
<form class="form-horizontal" method="POST" action="marketupdate.php">

             
			 
			 <h2 style="color:black;margin-top:60px;"><i>please  fill market study birr.</i></h2>
...
<div class="form-group">
  ...
  <input  name="no" placeholder="enter no" class="form-control" value="<?php echo $no?>"; type="text">
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="itemname" placeholder="enter item name" class="form-control" value="<?php echo $itemname?>"; type="text">
    </div>
  </div>
</div>
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input  name="imodel" placeholder="enter item model" class="form-control"  value="<?php echo $itemmodel?>"; type="text">
    </div>
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label">Market Study Birr:</label>  
  <div class="col-md-4 inputGroupContainer">
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
 <input class="form-control"  type="text" name="mbirr" onKeyPress="return ValidateAlpha(event)"required>
    </div>
  </div>
</div>

<input   type="submit" class="btn btn-primary active" name="fill" onclick="return confirm(' Are You sure You want to Add market study birr?')" value="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input  class="btn btn-danger active" type="reset" name="reset" value="reset">
</form>
</div>
