...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="navbar-header">
     ...
     <a href="index.php"><img style="margin-top:-80px;margin-left:-10px;" src="images/ww.png" width="95px" 
   height="85px"></a>
    </div>
    <div>
...
$mysql=mysqli_connect('localhost','root','');
		...
		?>
 <table border="1" width="1000" align="center" id="table1"cellpadding="3" class="mytable" cellspacing="0">
                <tr>
<th>rid </th>
