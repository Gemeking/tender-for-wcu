...
<fieldset>
 ...
 <table border="2" width="900" align="center" cellpadding="3" class="mytable" cellspacing="0">
  <img src="images/fa.jfif"  style="height:300px;width:70%;">
                <tr>
...
<th> close_date </th><th> Assess_Date </th><th>Reason</th><th>Result</th><th>Status</th>
			  ...
			  $query = mysqli_query($mysql," SELECT * FROM assessdsupplier where assess='Fail' and status='Approved'");
			  if(!$query){
    echo'<script> alert("There is no assessed supplier!!!")</script>'.mysqli_error($mysql);
}else{
...
<?php
  ...
  $res=mysqli_query($mysql,$sql);
    ...
    ?>
	 <tr>
             <td align="center" colspan="20" style="color:blue;"><i> <h4><?php echo "Total ".$rec."  suppliers fail"; ?></h4></i></td>
